...
class ElasticsearchConnection extends EventEmitter {
	...
	constructor(url=null, indexConfigs={}, options={}) {
		super();
		...
		// for this connection.
		this.indexManager = new ElasticsearchIndexManager(this, indexConfigs, options.indexOptions);

		// Call initialize
		if (options.initialize !== false && url) {
			this.initialize();
		}
	}
