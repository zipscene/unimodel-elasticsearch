...
class ElasticsearchModel extends SchemaModel {
	 ...
	 *   @param {String} [options.scrollTimeout='2m'] - Timeout before the scroll is deleted
	 ...
	 *   @param {Boolean} [options.refersh] - If true, refresh the index after saving.
	...
	update(query, update, options = {}) {
		...
		let saveOpts = _.pick(options, [ 'consistency', 'refresh', 'replication']);
