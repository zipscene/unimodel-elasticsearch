const { defaultQueryFactory } = require('zs-common-query');
const XError = require('xerror');

// Register new common query operators and export register function
const operators = require('./operators');
operators.registerQueryOperators(defaultQueryFactory);
exports.registerQueryOperators = operators.registerQueryOperators;
